...
public class HorizontalPicker extends LinearLayout implements HorizontalPickerListener {
    ...
    public void init() {
        ...
        tvMonth.setTextColor(mMonthAndYearTextColor != -1 ? mMonthAndYearTextColor : getColor(R.color.red));
        ...
        mDateSelectedTextColor = mDateSelectedTextColor == -1 ? R.color.white : mDateSelectedTextColor;
        mTodayDateTextColor = mTodayDateTextColor == -1 ? getColor(R.color.white) : mTodayDateTextColor;
        mDayOfWeekTextColor = mDayOfWeekTextColor == -1 ? getColor(R.color.grey) : mDayOfWeekTextColor;
